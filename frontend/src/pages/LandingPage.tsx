...
export function LandingPage() {
  ...
  return (
    <div style={{ fontFamily: "'Pretendard', 'Apple SD Gothic Neo', sans-serif", color: '#0F172A' }}>
      ...
      >
        ...
        >
          ...
          <div style={{ flex: '1 1 400px', minWidth: 0 }}>
            ...
            <h1 className="fade-up-2" style={{ fontWeight: 900, fontSize: 'clamp(2rem, 5vw, 3.4rem)', lineHeight: 1.15, marginBottom: 20, letterSpacing: '-1px' }}>
              모든 아이의 급식을<br />
              <span className="gradient-text">안전하게</span>
            </h1>

            <p className="fade-up-3" style={{ fontSize: '1.1rem', color: '#475569', lineHeight: 1.75, marginBottom: 32, maxWidth: 480 }}>
              알레르기 정보를 한 번만 등록하면, AI가 위험 메뉴를 실시간으로 감지하고
              급식 전날 맞춤 알림을 보내드립니다.
            </p>
          ...
          {/* 마스코트 */}
          <div
            style={{ flex: '1 1 320px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}
          >
            <img
              src="/mascot.png"
              alt="알라리알라 마스코트"
      ...
      <section style={{ background: '#fff', padding: '80px 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div className="text-center mb-5">
            ...
            <h2 style={{ fontWeight: 800, fontSize: 'clamp(1.6rem, 3vw, 2.2rem)', letterSpacing: '-0.5px' }}>
      ...
      <section style={{ background: '#F8FAFC', padding: '80px 24px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <div className="d-flex align-items-start flex-column flex-md-row gap-4 gap-md-0">
            {STEPS.map((step, i) => (
              <div key={step.num} className="d-flex align-items-start flex-md-column w-100" style={{ flex: 1 }}>
                ...
                <div className="mt-3 ps-md-0 ps-3">
                  <h6 style={{ fontWeight: 700, fontSize: '0.95rem', marginBottom: 6 }}>{step.title}</h6>
                  <p style={{ color: '#64748B', fontSize: '0.85rem', lineHeight: 1.7, margin: 0, maxWidth: 220 }}>
                    {step.desc}
                  </p>
                </div>
              </div>
      ...
      <section className="cta-section" style={{ padding: '72px 24px', textAlign: 'center' }}>
        <div style={{ maxWidth: 600, margin: '0 auto' }}>
          <h2 style={{ fontWeight: 800, fontSize: 'clamp(1.6rem, 3vw, 2.2rem)', color: '#fff', marginBottom: 14, letterSpacing: '-0.5px' }}>
            지금 바로 시작하세요
          </h2>
      ...
      <footer style={{ background: '#0F172A', color: '#94A3B8', padding: '40px 24px' }}>
        ...
        >
          <div className="d-flex align-items-center gap-2">
            ...
            <span style={{ fontWeight: 700, color: '#E2E8F0', fontSize: '0.9rem' }}>알라리알라</span>
          </div>
          <div style={{ fontSize: '0.8rem' }}>
            © 2025 AllerReAlert. 학교 급식 알레르기 관리 솔루션.
          </div>
          <div className="d-flex gap-4" style={{ fontSize: '0.82rem' }}>
            <Link to="/login" style={{ color: '#94A3B8', textDecoration: 'none' }}>로그인</Link>
            <Link to="/signup" style={{ color: '#94A3B8', textDecoration: 'none' }}>회원가입</Link>
          </div>
        </div>
      </footer>
